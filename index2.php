    ...
    <div class="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
      ...
      <nav aria-label="Header Navigation" class="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start">
        <ul class="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
          <li class="text-gray-600 md:mr-12 hover:text-green-600"><a href="#">Home</a></li>
          <?php if 
                (isset($_SESSION['is_admin'])){ ?>
                 <li class="text-gray-600 md:mr-12 hover:text-green-600"><a href="/admin/index.php">Dashboard</a></li>
                <?php } ?>
         <?php if 
                (!isset($_SESSION['is_admin'])){ ?>
                 <li class="text-gray-600 md:mr-12 hover:text-green-600"><a href="/admin/product2.php">Add product</a></li>
                <?php } ?>     
          <li class="text-gray-600 md:mr-12 hover:text-green-600">
            <a href="log_out.php"><button class="rounded-full border-2 border-green-600 px-6 py-1 font-medium text-green-600 transition-colors hover:bg-green-600 hover:text-white">Log out</button></a>
          </li>
                ...
                <a href="detail.php"
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <h6 class="font-semibold text-base leading-7 text-black "><?php echo $row['img_price']?></h6>
                            <h6 class="font-semibold text-base leading-7 text-green-600 text-right">$100</h6>
                        </div>
