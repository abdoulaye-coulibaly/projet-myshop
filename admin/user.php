        ...
        <div class="flex flex-col">
          ...
          <div class="w-full flex justify-between border rounded-lg border-gray-300 bg-gray-50 items-center mb-3 mt-1 pl-3">
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8 p-2">
                                ...
                                <div class="p-6 pt-0 ">
                                  ...
                                  <div class="">
                                    ...
                                    <div class="text-center">
                                      <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Êtes-vous sure d'ajouter ce utilisateur ?</h3>
                                      <a href="#"  onclick="closeModal('modelConfirm')"
                                          class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-3 py-2.5 text-center mr-2">
                                          Annuler
                                      </a>
                                      <input type="submit" name="submit" value="Ajouter" onclick="closeModal('modelConfirm') class="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-cyan-200 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center"
                    ...
                    <!-- FIN DE MODAL POUR AJOUTER UN UTILISATEUR  -->
                        ...
                        <table class="w-full rounded-xl">
                            <thead>
                                <tr class="bg-gray-50">
                                    ...
                                    <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Admin </th>
                                </tr>
                            </thead>
                            ...
                            <?php
                                ...
                                $show_user= new users_informatioin();
                                $row=$show_user->show_user();
                                foreach($row as $row){
                                echo "
                                       <tr class='bg-white transition-all duration-500 hover:bg-gray-50'>
                                    <td class='p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900'> " .$row["user_name"]."</td>
                                    <td class='w-48 px-5 py-3'>
                                        <div class='flex items-center gap-3'>
                                                <p class='font-normal text-xs leading-5 text-gray-900'>" .$row["user_email"]." </p>
                                        </div>
                                    </td>
                                    <td class='p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900'>
                                        <div>
                                            <span>" .$row["user_sign_in_date"]."</span>
                                        </div>
                                    </td>
                                      <td class='flex p-5 items-center gap-0.5'>
                                     <a href='update.php?id=$row[id]'><i class='m-2 text-green-500 text-xl fa-solid fa-pen-to-square'></i> </a>
                                     <a href='delete.php?id=$row[id]'><i class='m-2 text-red-500 text-xl fa-solid fa-trash'></i> </a>
                                    </td>
                                    <td class='p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900'>" .$row["is_admin"]."</td>
                                </tr> 
                                    ";
                                }
                            ?>
