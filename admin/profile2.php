            ...
            <form class="flex flex-col items-stretch pt-3 pb-8 md:pt-8">
                <div class="grid gap-x-4 gap-y-3 sm:grid-cols-2">
                    <label class="block" for="name">
                        ...
                        <input class="w-full rounded-md border bg-white py-2 px-2 outline-none ring-green-500 focus:ring-2" type="name" name="name" placeholder="Entre votre name" />
                    </label>
                    <label class="block" for="phone">
                        <p class="mb-1 mt-2 text-sm text-gray-600">Email</p>
                        <input class="w-full rounded-md border bg-white py-2 px-2 outline-none ring-green-500 focus:ring-2" type="email" name="email" placeholder="Entrer votre Email" />
                    </label>
                    <label class="block" for="name">
                    <p class="mb-1 mt-2 text-sm text-gray-600">Password</p>
