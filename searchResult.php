...
$classInstance = new product_information();
$var = $classInstance->searchproduct($_GET['search']);
...
<body>
    ...
    <section class="relative h-64 sm:h-96 flex flex-col items-center justify-center text-center text-white ">
        ...
        <div class="video-content space-y-2 z-10">
            <h1 class="font-light text-6xl">Bienvenue sur notre site</h1>
            <h3 class="font-light text-3xl">My Shop Online</h3>
        </div>
    </section>

    <section class="mx-auto m-2 lg:mt-5 w-screen max-w-screen-md py-10 lg:py-20 leading-6"> 
      <form class="relative mx-auto flex w-full max-w-2xl items-center justify-between rounded-md border shadow-lg" action="" method="GET"> 
        <svg class="absolute left-2 block h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <circle cx="11" cy="11" r="8" class=""></circle>
          <line x1="21" y1="21" x2="16.65" y2="16.65" class=""></line>
        </svg>
        <input type="name" name="search" class="h-14 w-full rounded-md py-4 pr-40 pl-12 outline-none focus:ring-2" placeholder="Rechercher" />
        ...
        <div class="p-5 col-span-3">
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8">
                ...
                <a href="detail.php"
                    ...
                    <?php echo "
                    <img class='rounded-2xl h-80 w-80 object-cover' src=admin/Downloads/".$value['img_blob']." alt='Jacket image'>
                    "; ?>
                    <div
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <h6 class="font-semibold text-base leading-7 text-black "><?php echo $value['product_nom'] ?></h6>
                            <h6 class="font-semibold text-base leading-7 text-green-600 text-right"><?php echo $value['img_price'] ?>$</h6>
                        </div>
                        <p class="text-xs leading-5 text-gray-500"><?php echo $value['img_desc'] ?></p>
                    </div>
                </a>
 
                <?php }}else{?> 
                    <div><h1 class="text-2xl text-center text-red-600"><?php echo "Not found !";?></h1></div>
                <?php }?>
            </div>                                 
        </div>
    </div>
